        ...
        () => [
            {
                ...
                Cell: ({ row }) => (
                    <Tooltip
                        label={
                            row?.original?.flags.join(` ,`) || `No user flags`
                        }
                        placement="top"
                    >
                ...
                Cell: ({ row }) => (
                    <HStack justifyContent="center">
                        ...
                        >
                            <IconButton
                                onClick={() =>
                                    handlePromote(`admin`, row.original._id)
                                }
                                aria-label={
                                    row.original.isAdmin
                                        ? `Demote from admin`
                                ...
                                colorScheme={
                                    row.original.isAdmin ? `red` : `green`
                                }
                                variant="ghost"
                                icon={<FaUserShield />}
                            />
                        ...
                        >
                            <IconButton
                                onClick={() =>
                                    handlePromote(`reviewer`, row.original._id)
                                }
                                aria-label={
                                    row.original.isReviewer
                                        ? `Demote from reviewer`
                                ...
                                colorScheme={
                                    row.original.isReviewer ? `red` : `green`
                                }
                                variant="ghost"
                                icon={<FaUserPlus />}
                            />
